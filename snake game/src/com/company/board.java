...
public class board extends JPanel implements ActionListener{
    ...
    public void loadImages(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/downmouth.png"));
        downmouth  = i1.getImage();

        ImageIcon i2 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/enemy.png"));
        enemy = i2.getImage();

        ImageIcon i3 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/leftmouth.png"));
        leftmouth = i3.getImage();

        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/rightmouth.png"));
        rightmouth  = i4.getImage();

        ImageIcon i5 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/snakeimage.png"));
        snakeimage  = i5.getImage();

        ImageIcon i6 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/snaketitle.jpg"));
        snaketitle  = i6.getImage();

        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/upmouth.png"));
        upmouth  = i7.getImage();

        ImageIcon i8 = new ImageIcon(ClassLoader.getSystemResource("com/company/icon/snakebackground.jpg"));
